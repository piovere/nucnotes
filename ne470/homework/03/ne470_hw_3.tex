...
\problem
	...
	\part {\sloppy Obtain a plot of the $ \ce{^{241}Pu} $ total absorption cross section at 300K over the range $ 10^{-9} to 20 MeV $. Print out the plot and label the major features of the cross section behavior. Turn in the labeled plot.}
\solution
