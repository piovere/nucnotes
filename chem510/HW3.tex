...
Random noise can be fundamental (resulting from particle nature of light and matter) or non-fundamental (due to imperfect components and instrumentation). The sign and magnitude are unpredictable.

Non-random noise is never fundamental. The sign and magnitude of non-random noise are correlated in time.
